...
namespace EMap.OgcStandards.Services
{
    public abstract class WmtsService : OgcService, IWmtsService
    {
        ...
        public virtual Capabilities CreateCapabilities(string href)
        {
            ...
            OnlineResourceType[] serviceMetadataURLs = new OnlineResourceType[]
            {
               new OnlineResourceType()
               {
                   href=$"{href}/1.0.0/WMTSCapabilities.xml"
               }
            };
            Capabilities capabilities = new Capabilities()
            {
                ...
                ServiceMetadataURL= serviceMetadataURLs,
                version = Version
            };
            return capabilities;
        }
